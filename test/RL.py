...
def update_green_time(x_new):
    ...
    if punishment_received==1:
        if x_new > x_old:  # Traffic increased, increase green time
            t_new_gt = min(50, t_old_gt + penalty_adjustment)
    ...
    print("\n Update Historical",historical_data,"\n")
    print("\n Fixed GT",fixed_green_times,"\n")
    print("\n Update gt_history",gt_history,"\n")
    print("\n Update new_vc",x_new,"\n")
    return t_new_gt
...
def update_penalty(vehicle_count):
    ...
    print("\nPenalty Historical",historical_data,"\n")
